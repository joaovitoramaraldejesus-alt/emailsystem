O sistema foi desenvolvido utilizando Java Spring Boot, PgAdmin e RabbitMQ. 
Os e-mails são cadastrados através de uma interface HTML simples e armazenados no banco de dados.
